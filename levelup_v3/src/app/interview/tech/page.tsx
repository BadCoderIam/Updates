      ...
      <div className="card" style={{ flex: "1 1 660px" }}>
        ...
        {pendingOffer && offerReadyAt && (
          <div className="card" style={{ marginTop: 14 }}>
            <p style={{ margin: 0 }}><b>Congrats — offer is being prepared…</b></p>
              ...
              {offer ? (
                <>
                  <div className="card">
                    ...
                    <p style={{ margin: "6px 0" }}><small>{offer.companyName} • {offer.roleLabel}</small></p>
